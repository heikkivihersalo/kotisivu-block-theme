...
class AssetServiceProvider extends ServiceProvider {
    ...
    public function register(): void {
        ...
        Asset::style('kotisivu-inline-css', 'build/assets/inline.css', 'build/app/admin.asset.php', 11, true, true);
        Asset::style('kotisivu-tailwind-utility-css', 'build/assets/tailwind-utilities.css', 'build/app/admin.asset.php', 11, true, true);
