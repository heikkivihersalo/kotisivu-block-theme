 ...
 */
const Pulse2 = (props: Pick<SvgIcon, 'className'>): JSX.Element => (
	<svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} {...props}>
		<style>
			{
				'@keyframes spinner_qV4G{0%{r:0;opacity:1}to{r:11px;opacity:0}}.spinner_ZCsl{animation:spinner_qV4G 1.2s cubic-bezier(.52,.6,.25,.99) infinite}'
			}
		</style>
	</svg>
);
