...
![Static Badge](https://img.shields.io/badge/Block_Theme-blue?logo=wordpress) ![GitHub repo size](https://img.shields.io/github/repo-size/heikkivihersalo/kotisivu-block-theme) ![GitHub last commit (branch)](https://img.shields.io/github/last-commit/heikkivihersalo/kotisivu-block-theme/main) [![PHP](https://github.com/heikkivihersalo/kotisivu-block-theme/actions/workflows/php.yml/badge.svg)](https://github.com/heikkivihersalo/kotisivu-block-theme/actions/workflows/php.yml) ![GitHub](https://img.shields.io/github/license/heikkivihersalo/kotisivu-block-theme)
