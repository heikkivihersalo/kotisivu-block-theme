...
?>
<button id="color-scheme-toggle" class="scheme-toggle" title="<?php _e('Toggles light and dark color scheme', 'kotisivu-block-theme'); ?>" aria-label="auto" aria-live="polite">
    <!-- Light Mode SVG -->
