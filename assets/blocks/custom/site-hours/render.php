...
?>
    <?php ob_start(); ?>
    <div class="site-contact site-contact--hours is-layout-flex is-content-alignment-center has-small-gap">
        ...
        <div class="site-contact__text">
            <?php echo isset($attributes["options"]['contact-opening-hours']) ? $attributes["options"]['contact-opening-hours'] : ''; ?>
        </div>
    </div>
