...
<a class="site-contact site-contact--email" href="mailto:<?php echo $contact['email'] ?>" target="_blank" rel="noopener noreferrer" aria-label="<?php echo __('Send email to', 'kotisivu-block-theme') . ' ' . $contact['email'] ?>" data-track="true" data-type="email" data-label="Email">
