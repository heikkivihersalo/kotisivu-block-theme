...
function updateBlockMarkup(element, blockType, attributes) {
    ...
    const imageBlock = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)('img', {
        className: classnames__WEBPACK_IMPORTED_MODULE_1___default()('wp-block-image', className, attributes.className, (0,_utils__WEBPACK_IMPORTED_MODULE_2__.getBlockSizeClass)(attributes?.sizeSlug), getAlignmentClass(attributes?.align)),
        src,
        title,
        alt,
        height,
...
"use strict";
module.exports = JSON.parse('[{"name":"primary-fill","label":"Primary (Fill)","isDefault":true},{"name":"primary-outline","label":"Primary (Outline)"},{"name":"primary-arrow","label":"Primary (Arrow)"},{"name":"secondary-fill","label":"Secondary (Fill)"},{"name":"secondary-outline","label":"Secondary (Outline)"},{"name":"secondary-arrow","label":"Secondary (Arrow)"}]');
...
"use strict";
module.exports = JSON.parse('[{"name":"default","label":"Default","isDefault":true},{"name":"square","label":"Square"}]');
...
"use strict";
module.exports = JSON.parse('[{"name":"default","label":"Default","isDefault":true},{"name":"centered","label":"Centered","isDefault":false}]');
