 ...
 */
function add_duplicate_post_link_to_admin( array $actions, \WP_Post $post ): array {
 ...
 * @return void
 */
function create_duplicate_post_as_draft(): void {
 ...
 * @return void
 */
function show_duplicate_admin_notice(): void {
