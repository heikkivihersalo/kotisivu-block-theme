...
class BlockCore {
    ...
    public function enqueue_core_blocks(): void {
        // Get assets file
        $assets_file = require $this->parent_path . '/assets/blocks/core/core.asset.php';

        wp_enqueue_script(
            'block-core',
            $this->parent_uri . '/assets/blocks/core/core.js',
        ...
        wp_enqueue_style(
            'block-core',
            $this->parent_uri . '/assets/blocks/core/core.css',
            [],
            $assets_file['version'],
            'all'
        );
