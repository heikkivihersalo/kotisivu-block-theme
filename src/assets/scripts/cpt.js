...
document.addEventListener('DOMContentLoaded', () => {
	const UPLOAD_IMAGE_BUTTON_CHOOSE = document.querySelector(
		'.image-uploader__button--choose'
	);
	const UPLOAD_IMAGE_INPUT = document.querySelector(
		'.image-uploader__input-field'
	);
	const UPLOAD_IMAGE_BUTTON_REMOVE = document.querySelector(
		'.image-uploader__button--remove'
	);
	const UPLOAD_IMAGE_PREVIEW = document.querySelector(
	...
	UPLOAD_IMAGE_BUTTON_CHOOSE.addEventListener('click', (e) => {
		...
		frame.on('select', () => {
			...
			// Show "Remove" button
			UPLOAD_IMAGE_BUTTON_REMOVE.classList.remove(
				'is-visually-hidden--no-tag'
			);

			// Hide "Choose" button
			UPLOAD_IMAGE_BUTTON_CHOOSE.classList.add(
				'is-visually-hidden--no-tag'
			);
		});
	...
	UPLOAD_IMAGE_BUTTON_REMOVE.addEventListener('click', (e) => {
		...
		// Show "Choose" button
		UPLOAD_IMAGE_BUTTON_CHOOSE.classList.remove(
			'is-visually-hidden--no-tag'
		);
