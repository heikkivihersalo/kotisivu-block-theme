            ...
            <PanelBody title={__('Width Controls', 'kotisivu-block-theme')}>
                    ...
                    <div className="editor-width-controls">
                        ...
                        <ButtonGroup>
                            <Button
                                ...
                                onClick={() => onStyleChange(attributes.style, 'width', FULL_WIDTH)}
                            />
                            <Button
                                ...
                                onClick={() => onStyleChange(attributes.style, 'width', CONTENT_WIDTH)}
                            />
                            <Button
                                label="Set width as narrow"
                                showTooltip="true"
                                icon={<WidthNarrow />}
                                isPressed={attributes.style?.width === NARROW_WIDTH}
                                onClick={() => onStyleChange(attributes.style, 'width', NARROW_WIDTH)}
                            />
                        </ButtonGroup>
                    </div>
                </PanelRow>
                <PanelRow>
                    <ToggleControl
                        ...
                        onChange={() => onStyleChange(attributes.style, 'height', "100%")}
                    />
                </PanelRow>
            </PanelBody>
        </>
