...
domReady(function () {
    const LANG_PICKER_DROPDOWN = document.getElementsByClassName("language-picker__dropdown")[0];
    const LANG_PICKER_BUTTON = document.getElementsByClassName("language-picker__button")[0];
    ...
    function handleCountryPickerClicks() {
        ...
        document.addEventListener("click", (e) => {
            if (!LANG_PICKER_DROPDOWN.contains(e.target) && !LANG_PICKER_BUTTON.contains(e.target)) {
        ...
        LANG_PICKER_BUTTON.addEventListener("click", () => {
            const currentState = LANG_PICKER_BUTTON.getAttribute("aria-expanded");
