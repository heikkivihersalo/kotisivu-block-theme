...
function render_site_phone($block_attributes, $content) { ?>
    ...
    <?php ob_start(); ?>
    <a class="site-contact site-contact--phone" href="tel:<?php echo format_phone_num($contact['phone']) ?>" target="_blank" rel="noopener noreferrer" title="<?php _e($contact['title'], 'kotisivu-block-theme'); ?>" aria-label="<?php _e($contact['aria-label'], 'kotisivu-block-theme'); ?>" data-track="true" data-type="phone" data-label="Phone">
